...
persistent RandNoGos CountNoGos TrackGoTrials min_nogos max_nogos
...
if TRIALS.TrialIndex == 1
   ...
   min_nogos = ismember(TRIALS.writeparams,'Stim.MIN_NOGOS');
   max_nogos = ismember(TRIALS.writeparams,'Stim.MAX_NOGOS');
