function varargout = Appetitive_training_Food(varargin)
%
...
set(handles.num_pellets,'ForegroundColor',[0 0 1]);
set(handles.apply,'enable','off');
...
%Get number of pellets dispensed from GUI and send back to RPVds circuit
num_pellets  = getval(handles.num_pellets);
handles.RP.SetTagVal('num_pellets',num_pellets);
...
persistent starttime timestamps spout_hist sound_hist
