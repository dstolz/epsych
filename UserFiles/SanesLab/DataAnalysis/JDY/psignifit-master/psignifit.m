...
% the program produced for your fit. You can pass this as whole to allplotOptions
...
switch options.expType
    case 'YesNo'
        if ~isfield(options,'stepN'),   options.stepN   = [40,40,50,20,20];  end %stepN=[40,40,20,20,20]
