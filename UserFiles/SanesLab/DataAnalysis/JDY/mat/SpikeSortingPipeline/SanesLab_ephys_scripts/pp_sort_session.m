function Spikes = pp_sort_session( subject, session, block, datadir, Threshold )
% 
...
segment_length_s = diff(win)/1000;  %length of each data segment (sec)

[thresh, reject] = calculate_thresholds(Phys, segment_length_s, Threshold, win, fs);
