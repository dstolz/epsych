...
%     plot([unique_stim(ks,4) unique_stim(ks,4)],[-30 30],'k:')
    ...
    xlabel( 'Time (ms)')
	set(gca,'XTick',-200:50:1000,'XTickLabel',-200:50:1000);
    ylabel('Spikes/sec')
    hold off
	title(['Ch: ' num2str(channel) '; Freq: ' num2str(unique_stim(ks,1)) ' Hz; dBSPL: ' num2str(unique_stim(ks,2))])
