...
for i = 1:RUNTIME.NSubjects
    ...
    if RUNTIME.UseOpenEx
        ...
        data.Freq = feval(sprintf('GetTagVal',RUNTIME.TYPE),AX,'Freq1'); %Hz
        data.dBSPL = feval(sprintf('GetTagVal',RUNTIME.TYPE),AX,'dBSPL1');
        data.Freq2 = feval(sprintf('GetTagVal',RUNTIME.TYPE),AX,'Freq2'); %Hz
        data.dBSPL2 = feval(sprintf('GetTagVal',RUNTIME.TYPE),AX,'dBSPL2');
        ...
        data.ISI = feval(sprintf('GetTagVal',RUNTIME.TYPE),AX,'ISI'); %msec
        ...
        data.Stim1_Duration = Stim1_Duration/data.fs; %msec
        data.FMdepth2 = feval(sprintf('GetTagVal',RUNTIME.TYPE),AX,'FMdepth2'); %percent
        data.FMrate2 = feval(sprintf('GetTagVal',RUNTIME.TYPE),AX,'FMrate2'); %Hz
        data.AMdepth2 = feval(sprintf('GetTagVal',RUNTIME.TYPE),AX,'AMdepth2'); %percent
        data.AMrate2 = feval(sprintf('GetTagVal',RUNTIME.TYPE),AX,'AMrate2'); %Hz
        Stim2_Duration = feval(sprintf('GetTagVal',RUNTIME.TYPE),AX,'Stim2_Dur'); %samples
        data.Stim2_Duration = Stim2_Duration/data.fs; %msec
