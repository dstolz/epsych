function RUNTIME = ep_TimerFcn_Start_TwoInterval_SanesLab(CONFIG, RUNTIME, AX)
...
if find(cell2mat(strfind(RUNTIME.TRIALS.writeparams,'AMdepth')))
    ...
    RUNTIME.TRIALS(i).DATA.Freq2 = [];
    RUNTIME.TRIALS(i).DATA.dBSPL2 = [];    
    ...
    RUNTIME.TRIALS(i).DATA.Stim1_Duration = [];
    RUNTIME.TRIALS(i).DATA.Stim2_Duration = [];
    RUNTIME.TRIALS(i).DATA.ISI = [];
    ...
    RUNTIME.TRIALS(i).DATA.FMdepth2 = [];
    RUNTIME.TRIALS(i).DATA.FMrate = [];
    RUNTIME.TRIALS(i).DATA.FMrate2 = [];
    RUNTIME.TRIALS(i).DATA.AMdepth = [];
    RUNTIME.TRIALS(i).DATA.AMdepth2 = [];
    RUNTIME.TRIALS(i).DATA.AMrate = [];
    RUNTIME.TRIALS(i).DATA.AMrate2 = [];
