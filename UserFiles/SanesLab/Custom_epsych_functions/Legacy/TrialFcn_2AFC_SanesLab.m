function NextTrialID = TrialFcn_2AFC_SanesLab(TRIALS)
...
% appetitive Two-Alternative Forced Choice tasks.
%
...
% Updated by JD Yao Jan 27 2016
%warning('off','MATLAB:hg:uicontrol:ParameterValuesMustBeValid');

global RUNTIME USERDATA ROVED_PARAMS GUI_HANDLES PUMPHANDLE %NEED TO ADD SECOND PUMPHANDLE%
...
%         %%%---Updated to add second Pumphandle---%%%
%         PUMPHANDLE1 = TrialFcn_PumpControl;
%         PUMPHANDLE2 = TrialFcn_PumpControl;
...
try
    ...
    if TRIALS.trials{NextTrialID,trial_type_ind} == 0
%         Next_trial_type = 'GO';
        Next_trial_type = 'Same';
    elseif TRIALS.trials{NextTrialID,trial_type_ind} == 1;
%         Next_trial_type = 'NOGO';
        Next_trial_type = 'Different';
    end
...
function [Different_lim,repeat_checkbox,Same_prob,same_indices,different_indices,...
    Expected_prob,expect_indices,unexpect_indices] = ...
    getIndices(TRIALS,trial_type_ind,expected_ind)
