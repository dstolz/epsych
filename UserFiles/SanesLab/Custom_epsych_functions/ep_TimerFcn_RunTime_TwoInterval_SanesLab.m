function RUNTIME = ep_TimerFcn_RunTime_TwoInterval_SanesLab(RUNTIME, AX)
...
for i = 1:RUNTIME.NSubjects
    ...
    if RUNTIME.UseOpenEx
        data.Freq = feval(sprintf('GetTargetVal',RUNTIME.TYPE),AX,'Behavior.Freq1'); %Hz
        data.dBSPL = feval(sprintf('GetTargetVal',RUNTIME.TYPE),AX,'Behavior.dBSPL1');
        data.Freq2 = feval(sprintf('GetTargetVal',RUNTIME.TYPE),AX,'Behavior.Freq2'); %Hz
        data.dBSPL2 = feval(sprintf('GetTargetVal',RUNTIME.TYPE),AX,'Behavior.dBSPL2');
        ...
        data.ISI = feval(sprintf('GetTargetVal',RUNTIME.TYPE),AX,'Behavior.ISI'); %msec
        ...
        data.FMdepth = feval(sprintf('GetTargetVal',RUNTIME.TYPE),AX,'Behavior.FMdepth1'); %percent
        data.FMrate = feval(sprintf('GetTargetVal',RUNTIME.TYPE),AX,'Behavior.FMrate1'); %Hz
        data.AMdepth = feval(sprintf('GetTargetVal',RUNTIME.TYPE),AX,'Behavior.AMdepth1'); %percent
        data.AMrate = feval(sprintf('GetTargetVal',RUNTIME.TYPE),AX,'Behavior.AMrate1'); %Hz
        Stim1_Duration = feval(sprintf('GetTargetVal',RUNTIME.TYPE),AX,'Behavior.Stim1_Dur'); %samples
        data.Stim1_Duration = Stim1_Duration/data.fs; %msec
        
        data.FMdepth2 = feval(sprintf('GetTargetVal',RUNTIME.TYPE),AX,'Behavior.FMdepth2'); %percent
        data.FMrate2 = feval(sprintf('GetTargetVal',RUNTIME.TYPE),AX,'Behavior.FMrate2'); %Hz
        data.AMdepth2 = feval(sprintf('GetTargetVal',RUNTIME.TYPE),AX,'Behavior.AMdepth2'); %percent
        data.AMrate2 = feval(sprintf('GetTargetVal',RUNTIME.TYPE),AX,'Behavior.AMrate2'); %Hz
        Stim2_Duration = feval(sprintf('GetTargetVal',RUNTIME.TYPE),AX,'Behavior.Stim2_Dur'); %samples
        data.Stim2_Duration = Stim2_Duration/data.fs; %msec
        data.Optostim = feval(sprintf('GetTargetVal',RUNTIME.TYPE),AX,'Optostim'); %Logical
    else
        data.Freq = feval(sprintf('GetTargetVal',RUNTIME.TYPE),AX,'Freq1'); %Hz
        data.dBSPL = feval(sprintf('GetTargetVal',RUNTIME.TYPE),AX,'dBSPL1');
        data.Freq2 = feval(sprintf('GetTargetVal',RUNTIME.TYPE),AX,'Freq2'); %Hz
        data.dBSPL2 = feval(sprintf('GetTargetVal',RUNTIME.TYPE),AX,'dBSPL2');
        data.Expected = feval(sprintf('GetTargetVal',RUNTIME.TYPE),AX,'Expected'); %Logical
        data.MinPokeDur = feval(sprintf('GetTargetVal',RUNTIME.TYPE),AX,'MinPokeDur'); %msec
        data.RespWinDelay = feval(sprintf('GetTargetVal',RUNTIME.TYPE),AX,'RespWinDelay'); %msec
        data.RespWinDur = feval(sprintf('GetTargetVal',RUNTIME.TYPE),AX,'RespWinDur'); %msec
        data.Silent_delay = feval(sprintf('GetTargetVal',RUNTIME.TYPE),AX,'Silent_delay'); %msec
        data.ISI = feval(sprintf('GetTargetVal',RUNTIME.TYPE),AX,'ISI'); %msec
        data.to_duration = feval(sprintf('GetTagVal',RUNTIME.TYPE),AX,'to_duration'); %msec
        data.fs =  AX.GetSFreq; %Samples/sec; %Samples/sec
        
        data.FMdepth = feval(sprintf('GetTagVal',RUNTIME.TYPE),AX,'FMdepth1'); %percent
        data.FMrate = feval(sprintf('GetTagVal',RUNTIME.TYPE),AX,'FMrate1'); %Hz
        data.AMdepth = feval(sprintf('GetTagVal',RUNTIME.TYPE),AX,'AMdepth1'); %percent
        data.AMrate = feval(sprintf('GetTagVal',RUNTIME.TYPE),AX,'AMrate1'); %Hz
        Stim1_Duration = feval(sprintf('GetTagVal',RUNTIME.TYPE),AX,'Stim1_Dur'); %samples
        data.Stim1_Duration = Stim1_Duration/data.fs; %msec
        data.FMdepth2 = feval(sprintf('GetTargetVal',RUNTIME.TYPE),AX,'FMdepth2'); %percent
        data.FMrate2 = feval(sprintf('GetTargetVal',RUNTIME.TYPE),AX,'FMrate2'); %Hz
        data.AMdepth2 = feval(sprintf('GetTargetVal',RUNTIME.TYPE),AX,'AMdepth2'); %percent
        data.AMrate2 = feval(sprintf('GetTargetVal',RUNTIME.TYPE),AX,'AMrate2'); %Hz
        Stim2_Duration = feval(sprintf('GetTargetVal',RUNTIME.TYPE),AX,'Stim2_Dur'); %samples
        data.Stim2_Duration = Stim2_Duration/data.fs; %msec
