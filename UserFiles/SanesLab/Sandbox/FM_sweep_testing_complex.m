...
handles.RPfile = 'C:\gits\epsych\UserFiles\SanesLab\RPVdsCircuits\KP\FM_sweep_test_harmonics_noiseband.rcx';
...
duration = 1000;%ms
handles.RP.SetTagVal('StimDur',duration);
...
%             end
%         end
        handles.RP.SetTagVal('weight_1', 1);
        handles.RP.SetTagVal('weight_2', 0);
        handles.RP.SetTagVal('weight_3', 0);
        handles.RP.SetTagVal('weight_4', 0);
