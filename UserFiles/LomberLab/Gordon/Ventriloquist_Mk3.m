function varargout = Ventriloquist_Mk3(varargin)
% Ventriloquist_Mk3 MATLAB code for Ventriloquist_Mk3.fig
%      Ventriloquist_Mk3, by itself, creates a new Ventriloquist_Mk3 or raises the existing
%      singleton*.
%
%      H = Ventriloquist_Mk3 returns the handle to a new Ventriloquist_Mk3 or the handle to
%      the existing singleton*.
%
%      Ventriloquist_Mk3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in Ventriloquist_Mk3.M with the given input arguments.
%
%      Ventriloquist_Mk3('Property','Value',...) creates a new Ventriloquist_Mk3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Ventriloquist_Mk3_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Ventriloquist_Mk3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Ventriloquist_Mk3
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @Ventriloquist_Mk3_OpeningFcn, ...
                   'gui_OutputFcn',  @Ventriloquist_Mk3_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Ventriloquist_Mk3 is made visible.
function Ventriloquist_Mk3_OpeningFcn(hObject, eventdata, handles, varargin)
% Choose default command line output for Ventriloquist_Mk3
...
function varargout = Ventriloquist_Mk3_OutputFcn(hObject, eventdata, handles) 
