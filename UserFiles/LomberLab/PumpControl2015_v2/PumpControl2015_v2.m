function varargout = PumpControl2015_v2(varargin)
% PUMPCONTROL2015_V2 MATLAB code for PumpControl2015_v2.fig

% Edit the above text to modify the response to help PumpControl2015_v2
...
% --- Executes just before PumpControl2015_v2 is made visible.
...
function varargout = PumpControl2015_v2_OutputFcn(hObj, ~, h)  %#ok<INUSL>
...
sp = getpref('PumpControl2015_v2','PLOT',true);
if sp
...
prevdata = getpref('PumpControl2015_v2','ControlTable_Data',dfltpump);
...
aot = getpref('PumpControl2015_v2','AOT',false);
AlwaysOnTop(h,aot);

function StorePrefs(h)
setpref('PumpControl2015_v2','ControlTable_Data',get(h.ControlTable,'Data'));
setpref('PumpControl2015_v2','PLOT',strcmp(get(h.show_plot,'checked'),'on'));
setpref('PumpControl2015_v2','AOT',strcmp(get(h.always_on_top,'Checked'),'on'));
...
setpref('PumpControl2015_v2','ControlTable_Data',get(hObj,'Data'));
...
dflt = getpref('PumpControl2015_v2','configpath',cd);
...
setpref('PumpControl2015_v2','configpath',pn);
...
set(h.PumpControl,'Name',sprintf('PumpControl2015_v2 (%s)',fn(1:end-5)));
