function varargout = pp_CalibrationUtil(varargin)
% varargout = pp_CalibrationUtil(varargin)
%
% Daniel.Stolzberg@gmail.com 2014

% Edit the above text to modify the response to help pp_CalibrationUtil

% Last Modified by GUIDE v2.5 02-Aug-2014 17:31:37

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @pp_CalibrationUtil_OpeningFcn, ...
                   'gui_OutputFcn',  @pp_CalibrationUtil_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before pp_CalibrationUtil is made visible.
function pp_CalibrationUtil_OpeningFcn(hObj, ~, h, varargin)
% Choose default command line output for pp_CalibrationUtil
h.output = hObj;
...
% UIWAIT makes pp_CalibrationUtil wait for user response (see UIRESUME)
% uiwait(h.pp_CalibrationUtil);


% --- Outputs from this function are returned to the command line.
function varargout = pp_CalibrationUtil_OutputFcn(hObj, ~, h)  %#ok<INUSL>
